...
communication_one = Product.create!(name_en: "Listening to understand", ranking: 1, group: "Communication", description_en: "You wish to become more powerful in your communication by listening without judging or interfering with what is being said. You want to understand what motivates the speaker and make him feel heard. Individual and group solutions. Formats adapted to your needs.")
communication_two = Product.create!(name_en: "Presenting with Impact", ranking: 2, group: "Communication", description_en: "You wish to be comfortable and confident when you are performing in front of others. Obtaining buy-in and having impact are key for you. Individual and group solutions. Formats adapted to your needs.")
communication_three = Product.create!(name_en: "Giving feedback", ranking: 3, group: "Communication", description_en: "You wish to feel comfortable while giving feedback and want your message to come across whilst showing respect for the other. You want to inspire people and get buy-in even on the most difficult topics. You want to be open to receiving feedback. Individual and group solutions. Formats adapted to your needs.")
communication_four = Product.create!(name_en: "Communication for Experts", ranking: 4, group: "Communication", description_en: "As an expert in your field, you sometimes get lost when you need to communicate. Your message needs to be clear and concise and you wish to have an impact and feel confident. Individual and group solutions. Formats adapted to your needs.")
communication_five = Product.create!(name_en: "Delegating", ranking: 5, group: "Communication", description_en: "You wish to delegate in a way which makes people feel trusted and that you are helping them grow, while at the same time being efficient and ensuring transparency so that objectives are met. Individual and group solutions. Formats adapted to your needs.")
communication_six = Product.create!(name_en: "Assertiveness", ranking: 6, group: "Communication", description_en: "You want to have the confidence  to speak when you have something to say and to transmit your ideas decisively. You want to be able to clearly indicate your boundaries without infringing those of others. Individual and group solutions. Formats adapted to your needs.")
communication_seven = Product.create!(name_en: "Influencing & convincing", ranking: 7, group: "Communication", description_en: "You wish to speak up more in meetings, feel more comfortable expressing what you think, listen better and interact better with the people around you. Individual and group solutions. Formats adapted to your needs.")

engagement_one = Product.create!(name_en: "The engaged individual", subtitle_en: "Ignite engagement", ranking: 1, group: "Engagement", description_en: "A positive approach! Dynamic workshops which through values, connect individuals to self leadership and their intrinsic strengths so that they can become more impactful when contributing to others and to your organisation.")
engagement_two = Product.create!(name_en: "The connected team", subtitle_en: "Acting through engagement", ranking: 2, group: "Engagement", description_en: "Impactful workshops where individuals are facilitated in using their inner drivers to contribute towards the success of the  team. The outcome will be alignment in purpose and a clear action plan, a roadmap to success! Very valuable for new teams, remote teams, inter-generational teams and any scenario where building trust and collaboration are key.")
engagement_three = Product.create!(name_en: "The connected organisation", subtitle_en: "Amplify engagement", ranking: 3, group: "Engagement", description_en: "Workshops for larger organisations in which we train your people to become facilitators of our Values in Action workshops.")

languages_one = Product.create!(name_en: "Work & learn", ranking: 1, group: "Languages", description_en: "A language training embedded in your business project.")
languages_two = Product.create!(name_en: "The Atolo Classic", ranking: 2, group: "Languages", description_en: "Individual or group language courses. Duration and rhythms adapted to your reality. Like all classics, a learning journey your participants will never forget.")
languages_three = Product.create!(name_en: "Collaborative learning", ranking: 3, group: "Languages", description_en: "A dynamic team experience combining scrum meetings, individual coaching, group trainings.")
languages_four = Product.create!(name_en: "Languages & communication skills: A perfect blend", ranking: 4, group: "Languages", description_en: "Learning a language all the while developing a soft skill. The ideal combination.")
languages_five = Product.create!(name_en: "On the field language training ", ranking: 5, group: "Languages", description_en: "Languages learnt on the field. Master your language skills in your real work environment.")
languages_six = Product.create!(name_en: "Writing skills", ranking: 6, group: "Languages", description_en: "A tailored program focused on your writing where needed (reports, meeting minutes, customer care, audits…).")
languages_seven = Product.create!(name_en: "Phone or Skype ", ranking: 7, group: "Languages", description_en: "For those whose main line of communication isn't face to face or who simply need flexibility.")
languages_eight = Product.create!(name_en: "Speak up and share", ranking: 8, group: "Languages", description_en: "Conversation tables, interesting business topics, everyone is welcome. No rules except sharing ideas and thoughts in a target language.")
languages_nine = Product.create!(name_en: "A credit full of languages", ranking: 9, group: "Languages", description_en: "A line of credit covering a number of hours of training for those who have hectic agendas. No limits, pure flexibility, training when you need it.")
