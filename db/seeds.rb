...
engagement_one.update(description_fr: "Lors de ce workshop d’une demi-journée, nous vous faisons prendre conscience de ce qui vous anime, ce qui vous motive et ce qui constitue votre échelle de valeurs. Nous créons un cadre bienveillant où il est possible d’échanger avec vos collègues et ou le lien est établi avec votre organisation. Cette plateforme vous permettra de définir votre propre axe d’engagement et d’identifier les améliorations nécessaires au sein de votre environnement pour accélérer et ancrer un sentiment d’appartenance durable.")
