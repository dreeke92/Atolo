...
communication_one.update(name_fr: "Ecouter pour mieux comprendre", name_de: "", name_nl: "")
communication_two.update(name_fr: "Communiquer (présenter) avec impact", name_de: "", name_nl: "")
communication_three.update(name_fr: "Donner du feedback", name_de: "", name_nl: "")
communication_four.update(name_fr: "Communiquer pour des experts métiers", name_de: "", name_nl: "")
communication_five.update(name_fr: "Déléguer", name_de: "", name_nl: "")
communication_six.update(name_fr: "Faire preuve d’assertivité", name_de: "", name_nl: "")
communication_seven.update(name_fr: "Influencer et convaincre", name_de: "", name_nl: "")

engagement_one.update(name_fr: "Activer l’Engagement", name_de: "", name_nl: "")
engagement_two.update(name_fr: "Accélérer l‘Engagement", name_de: "", name_nl: "")
engagement_three.update(name_fr: "Ancrer l’Engagement", name_de: "", name_nl: "")

languages_one.update(name_fr: "Apprendre en travaillant", name_de: "", name_nl: "")
languages_two.update(name_fr: "Le Classic", name_de: "", name_nl: "")
languages_three.update(name_fr: "L’apprentissage collaboratif", name_de: "", name_nl: "")
languages_four.update(name_fr: "Un savant mélange de langues et de communication", name_de: "", name_nl: "")
languages_five.update(name_fr: "Formations en langues sur le terrain", name_de: "", name_nl: "")
languages_six.update(name_fr: "Développement de compétences à l’écrit", name_de: "", name_nl: "")
languages_seven.update(name_fr: "L’apprentissage par téléphone ou par Skype / Zoom", name_de: "", name_nl: "")
languages_eight.update(name_fr: "Partager ses opinions avec d’autres", name_de: "", name_nl: "")
languages_nine.update(name_fr: "Un crédit langues", name_de: "", name_nl: "")

puts "Adding different languages to product descriptions..."

communication_one.update(description_fr: "Vous souhaitez développer votre capacité d’écoute active. Cela, sans faire preuve de jugement, sans interrompre et afin de véritablement comprendre le processus de réflexion de vos interlocuteurs. Votre propre communication deviendra plus impactante. Nos solutions sont modulaires et adaptées à vos besoins.", description_de: "", description_nl: "")
communication_two.update(description_fr: "Vous souhaitez communiquer de façon assurée et en toute confiance. Il vous est important de générer de l’impact auprès de vos interlocuteurs tout en vous sentant pleinement à l’aise dans votre rôle. Cette solution est prévue en format individuel ou en groupe. Deux formules existent couvrant soit un jour complet ou deux journées complètes selon les besoins identifiés.", description_de: "", description_nl: "")
...
engagement_one.update(description_fr: "Lors de ce workshop d’une demi-journée, nous vous faisons prendre conscience de ce qui vous anime, ce qui vous motive et ce qui constitue votre échelle de valeurs. Nous créons un cadre bienveillant où il est possible d’échanger avec vos collègues et ou le lien est établi avec votre organisation. Cette plateforme vous permettra de définir votre propre axe d’engagement et d’identifier les améliorations nécessaires au sein de votre environnement pour accélérer et ancrer un sentiment d’appartenance durable.", description_de: "", description_nl: "")
engagement_two.update(description_fr: "Ce workshop planifié sur un jour et demi permet de faire le pont entre  'moi' et 'nous'. Il s’agit de la clé menant à des adaptations comportementales ciblées. Cette étape accélère le processus d’engagement en établissant des plans d’actions concrets, propres aux besoins de votre réalité professionnelle. Ce processus, inclusif et agile, délivrera un ensemble de valeurs collectif où chacun apportera sa pierre à l’édifice. Les actions définies auront pour but de soutenir le niveau d’engagement souhaité et seront au service des missions et de la vision définies par l’organisation et ses équipes. Des résultats tangibles en découleront et auront un impact positif, tant sur les résultats de l’organisation que sur le bien-être de ses collaborateurs.", description_de: "", description_nl: "")
engagement_three.update(description_fr: "Dédiés à un impact durable au sein de nos organisations partenaires et engagés à ancrer l’engagement au sein de votre culture d’entreprise, nous vous soutiendrons dans les démarches ad-hoc assurant cet engagement au sein de vos équipes. Plans de formations, stratégies de monitoring, conseils sur les priorités de développements individuels… nos experts sont à vos côtés pour définir la solution durable adaptée à vos besoins.", description_de: "", description_nl: "")

languages_one.update(description_fr: "Nous vous invitons à développer vos compétences linguistiques en appliquant des méthodologies d’apprentissage au sein d’un business case réel, propre à votre métier. Individuel ou en groupe. Format et nombre d’heures à définir avec votre conseiller selon vos vrais besoins.", description_de: "", description_nl: "")
languages_two.update(description_fr: "Une formation linguistique pour un ou plusieurs participants. La durée et le rythme sont établis selon les objectifs définis. Un trajet de formation court, ciblé et impactant.", description_de: "", description_nl: "")
languages_three.update(description_fr: "Une expérience en équipe visant une langue cible et mêlant des réunions flashs, du coaching individuel et des formations en groupes. En groupe. Format et nombre d’heures à définir avec votre conseiller selon vos vrais besoins.", description_de: "", description_nl: "")
languages_four.update(description_fr: "Tout en améliorant votre niveau linguistique, développez une compétence en communication. Individuel ou en groupe. Format et nombre d’heures à définir avec votre conseiller selon vos vrais besoins.", description_de: "", description_nl: "")
languages_five.update(description_fr: "Vous exercez vos compétences linguistiques dans votre environnement de travail journalier. Individuel ou en groupe. Format et nombre d’heures à définir avec votre conseiller selon vos vrais besoins.", description_de: "", description_nl: "")
...
languages_nine.update(description_fr: "Pour celles et ceux ayant un agenda très chargé et ayant besoin d’une solution flexible, modulaire et agile. La solution crédit permet une gestion selon vos besoins professionnels du moment et vos disponibilités.", description_de: "", description_nl: "")
