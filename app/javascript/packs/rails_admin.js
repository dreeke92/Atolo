...
//             <button type="button" class="trix-button trix-button--dialog d-none" data-trix-attribute="fgColor2" data-trix-method="hideDialog"></button>
//             <button type="button" class="trix-button trix-button--dialog d-none" data-trix-attribute="fgColor3" data-trix-method="hideDialog"></button>
//             <button type="button" class="trix-button trix-button--dialog d-none" data-trix-attribute="fgColor4" data-trix-method="hideDialog"></button>
//             <button type="button" class="trix-button trix-button--dialog d-none" data-trix-attribute="fgColor5" data-trix-method="hideDialog"></button>
//             <button type="button" class="trix-button trix-button--dialog d-none" data-trix-attribute="fgColor6" data-trix-method="hideDialog"></button>
//             <button type="button" class="trix-button trix-button--dialog d-none" data-trix-attribute="fgColor7" data-trix-method="hideDialog"></button>
//             <button type="button" class="trix-button trix-button--dialog d-none" data-trix-attribute="fgColor8" data-trix-method="hideDialog"></button>
//             <button type="button" class="trix-button trix-button--dialog d-none" data-trix-attribute="fgColor9" data-trix-method="hideDialog"></button>
//           </div>
//           <div class="trix-button-group d-none">
...
//   Array.from(["#48E27C", "rgb(185, 94, 6)", "rgb(207, 0, 0)", "rgb(216, 28, 170)", "rgb(144, 19, 254)", "rgb(5, 98, 185)", "rgb(17, 138, 15)", "rgb(148, 82, 22)", "rgb(102, 102, 102)"]).forEach((color, i) => {
...
//   Array.from(["#48E27C", "rgb(255, 240, 219)", "rgb(255, 229, 229)", "rgb(255, 228, 247)", "rgb(242, 237, 255)", "rgb(225, 239, 252)", "rgb(228, 248, 226)", "rgb(238, 226, 215)", "rgb(242, 242, 242)"]).forEach((color, i) => {
